...
MANUAL_CATALOG = [
    # ===================== SCAN =====================
    {
        ...
        "category_name": "Network Discovery",
        "steps": [
            {"step_key": "host_discovery", "step_name": "Host Discovery",
             "tools": ["netdiscover_arp_scan", "nbtscan_netbios", "nmap_vuln_scan"]},
            {"step_key": "port_service_scan", "step_name": "Port & Service Scan",
    ...
    },
    {
        ...
        "category_name": "Web Discovery",
        "steps": [
            {"step_key": "tech_fingerprint", "step_name": "Technology Fingerprint",
             "tools": ["whatweb_fingerprint", "wafw00f_detect"]},
            {"step_key": "content_discovery", "step_name": "Content & Directory Discovery",
    ...
    },
    {
        ...
        "category_name": "DNS & OSINT",
        "steps": [
            {"step_key": "dns_enum", "step_name": "DNS Enumeration",
             "tools": ["dnsrecon_dns_enum", "dnsenum_dns_enum"]},
            {"step_key": "osint_gather", "step_name": "OSINT Gathering",
    ...
    },
    {
        ...
        "category_name": "Service Enumeration",
        "steps": [
            {"step_key": "smb_netbios", "step_name": "SMB & NetBIOS",
             "tools": ["smbclient_shares", "enum4linux_smb_enum", "nbtscan_netbios"]},
            {"step_key": "tls_audit", "step_name": "TLS/SSL Audit",
    ...
    # ===================== ATTACK =====================
    {
        ...
        "category_name": "Web Attack",
        "steps": [
            {"step_key": "web_vuln_scan", "step_name": "Web Vulnerability Scan",
    ...
    },
    {
        ...
        "category_name": "Credential Attack",
        "steps": [
            {"step_key": "brute_force", "step_name": "Credential Brute-Force",
    ...
    },
    {
        ...
        "steps": [
            {"step_key": "metasploit_module", "step_name": "Metasploit Module",
    ...
    },
    {
        ...
        "steps": [
            {"step_key": "hash_crack", "step_name": "Hash Cracking",
    ...
    # ===================== REMEDIATION (retest) =====================
    {
        ...
        "category_name": "Re-validation",
        "steps": [
            {"step_key": "port_retest", "step_name": "Port/Service Retest",
             "tools": ["nmap_vuln_scan"]},
            {"step_key": "tls_retest", "step_name": "TLS Retest",
             "tools": ["sslscan_tls_audit"]},
            {"step_key": "web_retest", "step_name": "Web Vulnerability Retest",
    ...
    },
    {
        ...
        "category_name": "Remediation Verification",
        "steps": [
            {"step_key": "port_fix_verify", "step_name": "Port/Service Remediation Verification",
             "tools": ["nmap_remediation_verify"]},
            {"step_key": "web_fix_verify", "step_name": "Web Vulnerability Remediation Verification",
    ...
    },
    {
        ...
        "category_name": "Hardening Verification",
        "steps": [
            {"step_key": "tls_hardening_verify", "step_name": "TLS/SSL Hardening Verification",
             "tools": ["sslscan_remediation_verify"]},
            {"step_key": "http_headers_verify", "step_name": "HTTP Security Headers",
...
def _seed_block(block: dict, operations: dict) -> int:
    ...
    create_progress_category({
        ...
        "description": f"{block['category_name']} ({workflow_key}) manual validation steps.",
        "is_active": True,
    })
