...
TOOL = "curl"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": ["-sS", "-I"], "positionals_first": false, "params": [{"key": "target_url", "label": "Hedef URL", "kind": "positional", "flag": "", "setting": "TARGET_URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "insecure", "label": "Sertifika doğrulama yok (-k)", "kind": "flag", "flag": "-k", "setting": "INSECURE", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "follow", "label": "Yönlendirmeleri izle (-L)", "kind": "flag", "flag": "-L", "setting": "FOLLOW", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "user_agent", "label": "User-Agent", "kind": "opt", "flag": "-A", "setting": "USER_AGENT", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
