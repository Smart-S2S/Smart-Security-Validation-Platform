...
TOOL = "john"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "hashfile", "label": "Hash file", "kind": "positional", "flag": "", "setting": "HASHFILE", "default": "", "required": true, "pattern": "path", "choices": [], "must_exist": true}, {"key": "wordlist", "label": "Wordlist", "kind": "opt_eq", "flag": "--wordlist=", "setting": "WORDLIST", "default": "/usr/share/wordlists/rockyou.txt", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "format", "label": "Hash format", "kind": "opt_eq", "flag": "--format=", "setting": "FORMAT", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "rules", "label": "Rules", "kind": "flag", "flag": "--rules", "setting": "RULES", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "show", "label": "Show results", "kind": "flag", "flag": "--show", "setting": "SHOW", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "incremental", "label": "Incremental mode", "kind": "flag", "flag": "--incremental", "setting": "INCREMENTAL", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "single", "label": "Single mode", "kind": "flag", "flag": "--single", "setting": "SINGLE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "rules_named", "label": "Rule set", "kind": "opt_eq", "flag": "--rules=", "setting": "RULES_NAMED", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "fork", "label": "Fork count", "kind": "opt_eq", "flag": "--fork=", "setting": "FORK", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "mask", "label": "Mask", "kind": "opt_eq", "flag": "--mask=", "setting": "MASK", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
