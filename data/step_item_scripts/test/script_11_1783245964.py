...
TOOL = "wfuzz"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "wordlist", "label": "Wordlist file", "kind": "opt", "flag": "-w", "setting": "WORDLIST", "default": "/usr/share/wordlists/dirb/common.txt", "required": true, "pattern": "path", "choices": [], "must_exist": true}, {"key": "url", "label": "Target URL (FUZZ)", "kind": "opt", "flag": "-u", "setting": "URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "hide_codes", "label": "Hidden codes", "kind": "opt", "flag": "--hc", "setting": "HIDE_CODES", "default": "404", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "method", "label": "HTTP method", "kind": "opt", "flag": "-X", "setting": "METHOD", "default": "GET", "required": false, "pattern": "safe", "choices": ["GET", "POST", "PUT", "HEAD"], "must_exist": false}, {"key": "threads", "label": "Thread count", "kind": "opt", "flag": "-t", "setting": "THREADS", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "header", "label": "Extra header", "kind": "opt", "flag": "-H", "setting": "HEADER", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "postdata", "label": "POST data", "kind": "opt", "flag": "-d", "setting": "POSTDATA", "default": "", "required": false, "pattern": "url", "choices": [], "must_exist": false}, {"key": "cookie", "label": "Cookie", "kind": "opt", "flag": "-b", "setting": "COOKIE", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "hide_words", "label": "Hidden word count", "kind": "opt", "flag": "--hw", "setting": "HIDE_WORDS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "hide_lines", "label": "Hidden line count", "kind": "opt", "flag": "--hl", "setting": "HIDE_LINES", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "follow", "label": "Follow redirect (-L)", "kind": "flag", "flag": "-L", "setting": "FOLLOW", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
