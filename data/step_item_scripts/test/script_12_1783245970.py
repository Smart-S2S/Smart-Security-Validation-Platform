...
TOOL = "dnsrecon"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "domain", "label": "Domain", "kind": "opt", "flag": "-d", "setting": "DOMAIN", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "type", "label": "Scan type", "kind": "opt", "flag": "-t", "setting": "TYPE", "default": "std", "required": false, "pattern": "safe", "choices": ["std", "axfr", "brt", "srv", "rvl", "zonewalk"], "must_exist": false}, {"key": "nameserver", "label": "Name server", "kind": "opt", "flag": "-n", "setting": "NAMESERVER", "default": "", "required": false, "pattern": "host", "choices": [], "must_exist": false}, {"key": "wordlist", "label": "Wordlist file", "kind": "opt", "flag": "-D", "setting": "WORDLIST", "default": "", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "threads", "label": "Thread count", "kind": "opt", "flag": "--threads", "setting": "THREADS", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "axfr", "label": "Try zone transfer (-a)", "kind": "flag", "flag": "-a", "setting": "AXFR", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "reverse_range", "label": "Reverse DNS range", "kind": "opt", "flag": "-r", "setting": "REVERSE_RANGE", "default": "", "required": false, "pattern": "range", "choices": [], "must_exist": false}, {"key": "google_enum", "label": "Google enum (-g)", "kind": "flag", "flag": "-g", "setting": "GOOGLE_ENUM", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
