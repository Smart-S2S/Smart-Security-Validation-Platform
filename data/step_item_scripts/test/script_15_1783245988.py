...
"""Auto-generated SSVP wrapper for the "smbclient" tool (scan).
...
TOOL = "smbclient"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "host", "label": "SMB host", "kind": "opt", "flag": "-L", "setting": "HOST", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "no_pass", "label": "Parolasız (-N)", "kind": "flag", "flag": "-N", "setting": "NO_PASS", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "user", "label": "Kullanıcı", "kind": "opt", "flag": "-U", "setting": "USER", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "workgroup", "label": "Çalışma grubu", "kind": "opt", "flag": "-W", "setting": "WORKGROUP", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "command", "label": "Çalıştırılacak komut", "kind": "opt", "flag": "-c", "setting": "COMMAND", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "port", "label": "Port", "kind": "opt", "flag": "-p", "setting": "PORT", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
...
def _log(msg):
    print("[SMBCLIENT] " + str(msg), flush=True)
