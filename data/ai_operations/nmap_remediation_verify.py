...
TOOL = "nmap"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "target_host", "label": "Hedef host/IP", "kind": "positional", "flag": "", "setting": "TARGET_HOST", "default": "", "required": true, "pattern": "range", "choices": [], "must_exist": false}, {"key": "ports", "label": "Doğrulanacak portlar", "kind": "opt", "flag": "-p", "setting": "PORTS", "default": "1-1024", "required": false, "pattern": "ports", "choices": [], "must_exist": false}, {"key": "scan_type", "label": "Tarama tipi", "kind": "token", "flag": "", "setting": "SCAN_TYPE", "default": "-sT", "required": false, "pattern": "safe", "choices": ["-sT", "-sS", "-sU"], "must_exist": false}, {"key": "service_version", "label": "Servis sürümü (-sV)", "kind": "flag", "flag": "-sV", "setting": "SERVICE_VERSION", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "nse_scripts", "label": "NSE doğrulama scripti", "kind": "opt", "flag": "--script", "setting": "NSE_SCRIPTS", "default": "", "required": false, "pattern": "nse", "choices": [], "must_exist": false}, {"key": "open_only", "label": "Sadece açık portlar (--open)", "kind": "flag", "flag": "--open", "setting": "OPEN_ONLY", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "no_ping", "label": "Ping'i atla (-Pn)", "kind": "flag", "flag": "-Pn", "setting": "NO_PING", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timing", "label": "Hız şablonu", "kind": "token", "flag": "", "setting": "TIMING", "default": "-T3", "required": false, "pattern": "safe", "choices": ["-T2", "-T3", "-T4"], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
