...
TOOL = "whatweb"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "target_url", "label": "Hedef URL", "kind": "positional", "flag": "", "setting": "TARGET_URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "aggression", "label": "Saldırganlık düzeyi", "kind": "opt", "flag": "-a", "setting": "AGGRESSION", "default": "1", "required": false, "pattern": "safe", "choices": ["1", "3", "4"], "must_exist": false}, {"key": "user_agent", "label": "User-Agent", "kind": "opt", "flag": "-U", "setting": "USER_AGENT", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "max_threads", "label": "Maks. thread", "kind": "opt", "flag": "--max-threads", "setting": "MAX_THREADS", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "verbose", "label": "Ayrıntılı (-v)", "kind": "flag", "flag": "-v", "setting": "VERBOSE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "follow_redirect", "label": "Yönlendirme", "kind": "opt", "flag": "--follow-redirect", "setting": "FOLLOW_REDIRECT", "default": "always", "required": false, "pattern": "safe", "choices": ["never", "http-only", "meta-only", "same-site", "always"], "must_exist": false}, {"key": "cookie", "label": "Cookie", "kind": "opt", "flag": "--cookie", "setting": "COOKIE", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
