...
"""Auto-generated SSVP wrapper for the "sslscan" tool (scan).
...
TOOL = "sslscan"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "target", "label": "Hedef host[:port]", "kind": "positional", "flag": "", "setting": "TARGET", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "starttls", "label": "STARTTLS", "kind": "token", "flag": "", "setting": "STARTTLS", "default": "", "required": false, "pattern": "safe", "choices": ["--starttls-smtp", "--starttls-ftp", "--starttls-imap", "--starttls-pop3", "--starttls-ldap"], "must_exist": false}, {"key": "show_certificate", "label": "Sertifikayı göster", "kind": "flag", "flag": "--show-certificate", "setting": "SHOW_CERTIFICATE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "no_failed", "label": "Sadece kabul edilenler", "kind": "flag", "flag": "--no-failed", "setting": "NO_FAILED", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "show_ciphers", "label": "Şifre paketlerini göster", "kind": "flag", "flag": "--show-ciphers", "setting": "SHOW_CIPHERS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "no_cipher_details", "label": "Şifre detaylarını gizle", "kind": "flag", "flag": "--no-cipher-details", "setting": "NO_CIPHER_DETAILS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "ocsp", "label": "OCSP kontrolü", "kind": "flag", "flag": "--ocsp", "setting": "OCSP", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
