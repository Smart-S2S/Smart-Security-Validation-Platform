...
TOOL = "medusa"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "host", "label": "Target host", "kind": "opt", "flag": "-h", "setting": "HOST", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "module", "label": "Module", "kind": "opt", "flag": "-M", "setting": "MODULE", "default": "ssh", "required": true, "pattern": "word", "choices": ["ssh", "ftp", "telnet", "smbnt", "rdp", "mysql", "postgres", "vnc", "http", "web-form"], "must_exist": false}, {"key": "username", "label": "User", "kind": "opt", "flag": "-u", "setting": "USERNAME", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "userlist", "label": "User list", "kind": "opt", "flag": "-U", "setting": "USERLIST", "default": "", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "password", "label": "Password", "kind": "opt", "flag": "-p", "setting": "PASSWORD", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "passlist", "label": "Password list", "kind": "opt", "flag": "-P", "setting": "PASSLIST", "default": "/usr/share/wordlists/rockyou.txt", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "port", "label": "Port", "kind": "opt", "flag": "-n", "setting": "PORT", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "threads", "label": "Thread (-t)", "kind": "opt", "flag": "-t", "setting": "THREADS", "default": "4", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "stop_first", "label": "Stop at first hit (-f)", "kind": "flag", "flag": "-f", "setting": "STOP_FIRST", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "null_same", "label": "Extra attempt (-e)", "kind": "opt", "flag": "-e", "setting": "NULL_SAME", "default": "", "required": false, "pattern": "safe", "choices": ["n", "s", "ns"], "must_exist": false}, {"key": "verbose", "label": "Verbosity level (-v)", "kind": "opt", "flag": "-v", "setting": "VERBOSE", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "banner_suppress", "label": "Hide banner (-b)", "kind": "flag", "flag": "-b", "setting": "BANNER_SUPPRESS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
