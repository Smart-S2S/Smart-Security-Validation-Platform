...
TOOL = "msfconsole"
SPEC = json.loads(r'''{"mode": "msf_query", "fixed_pre": [], "positionals_first": false, "params": [{"key": "query_op", "label": "Operation", "kind": "none", "flag": "", "setting": "QUERY_OP", "default": "search", "required": false, "pattern": "safe", "choices": ["search", "info"], "must_exist": false}, {"key": "query", "label": "Search query", "kind": "none", "flag": "", "setting": "QUERY", "default": "", "required": false, "pattern": "msfquery", "choices": [], "must_exist": false}, {"key": "module", "label": "Module (for info)", "kind": "none", "flag": "", "setting": "MODULE", "default": "", "required": false, "pattern": "module", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "300", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
