...
"""Auto-generated SSVP wrapper for the "enum4linux" tool (scan).
...
TOOL = "enum4linux"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "all", "label": "Tüm bilgiler (-a)", "kind": "flag", "flag": "-a", "setting": "ALL", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "users", "label": "Kullanıcılar (-U)", "kind": "flag", "flag": "-U", "setting": "USERS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "shares", "label": "Paylaşımlar (-S)", "kind": "flag", "flag": "-S", "setting": "SHARES", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "os_info", "label": "OS bilgisi (-o)", "kind": "flag", "flag": "-o", "setting": "OS_INFO", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "host", "label": "Hedef host", "kind": "positional", "flag": "", "setting": "HOST", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "rid_cycle", "label": "RID döngüsü (-r)", "kind": "flag", "flag": "-r", "setting": "RID_CYCLE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "username", "label": "Kullanıcı", "kind": "opt", "flag": "-u", "setting": "USERNAME", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "password", "label": "Parola", "kind": "opt", "flag": "-p", "setting": "PASSWORD", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "groups", "label": "Gruplar (-G)", "kind": "flag", "flag": "-G", "setting": "GROUPS", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
...
def _log(msg):
    print("[ENUM4LINUX] " + str(msg), flush=True)
