...
"""Auto-generated SSVP wrapper for the "dnsrecon" tool (scan).
...
TOOL = "dnsrecon"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "domain", "label": "Alan adı", "kind": "opt", "flag": "-d", "setting": "DOMAIN", "default": "", "required": true, "pattern": "host", "choices": [], "must_exist": false}, {"key": "type", "label": "Tarama tipi", "kind": "opt", "flag": "-t", "setting": "TYPE", "default": "std", "required": false, "pattern": "safe", "choices": ["std", "axfr", "brt", "srv", "rvl", "zonewalk"], "must_exist": false}, {"key": "nameserver", "label": "Ad sunucusu", "kind": "opt", "flag": "-n", "setting": "NAMESERVER", "default": "", "required": false, "pattern": "host", "choices": [], "must_exist": false}, {"key": "wordlist", "label": "Sözlük dosyası", "kind": "opt", "flag": "-D", "setting": "WORDLIST", "default": "", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "threads", "label": "Thread sayısı", "kind": "opt", "flag": "--threads", "setting": "THREADS", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "axfr", "label": "Zone transfer dene (-a)", "kind": "flag", "flag": "-a", "setting": "AXFR", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "reverse_range", "label": "Ters DNS aralığı", "kind": "opt", "flag": "-r", "setting": "REVERSE_RANGE", "default": "", "required": false, "pattern": "range", "choices": [], "must_exist": false}, {"key": "google_enum", "label": "Google enum (-g)", "kind": "flag", "flag": "-g", "setting": "GOOGLE_ENUM", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
...
def _log(msg):
    print("[DNSRECON] " + str(msg), flush=True)
