...
"""Auto-generated SSVP wrapper for the "john" tool (attack).
...
TOOL = "john"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "hashfile", "label": "Hash dosyası", "kind": "positional", "flag": "", "setting": "HASHFILE", "default": "", "required": true, "pattern": "path", "choices": [], "must_exist": true}, {"key": "wordlist", "label": "Sözlük", "kind": "opt_eq", "flag": "--wordlist=", "setting": "WORDLIST", "default": "/usr/share/wordlists/rockyou.txt", "required": false, "pattern": "path", "choices": [], "must_exist": true}, {"key": "format", "label": "Hash formatı", "kind": "opt_eq", "flag": "--format=", "setting": "FORMAT", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "rules", "label": "Kurallar", "kind": "flag", "flag": "--rules", "setting": "RULES", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "show", "label": "Sonuçları göster", "kind": "flag", "flag": "--show", "setting": "SHOW", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "incremental", "label": "Incremental mod", "kind": "flag", "flag": "--incremental", "setting": "INCREMENTAL", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "single", "label": "Single mod", "kind": "flag", "flag": "--single", "setting": "SINGLE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "rules_named", "label": "Kural seti", "kind": "opt_eq", "flag": "--rules=", "setting": "RULES_NAMED", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "fork", "label": "Fork sayısı", "kind": "opt_eq", "flag": "--fork=", "setting": "FORK", "default": "", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "mask", "label": "Maske", "kind": "opt_eq", "flag": "--mask=", "setting": "MASK", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
