...
"""Auto-generated SSVP wrapper for the "wafw00f" tool (scan).
...
TOOL = "wafw00f"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "url", "label": "Hedef URL", "kind": "positional", "flag": "", "setting": "URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "find_all", "label": "Tüm WAF'ları ara (-a)", "kind": "flag", "flag": "-a", "setting": "FIND_ALL", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "verbose", "label": "Ayrıntılı (-v)", "kind": "flag", "flag": "-v", "setting": "VERBOSE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "proxy", "label": "Proxy", "kind": "opt", "flag": "-p", "setting": "PROXY", "default": "", "required": false, "pattern": "url", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
...
def _log(msg):
    print("[WAFW00F] " + str(msg), flush=True)
