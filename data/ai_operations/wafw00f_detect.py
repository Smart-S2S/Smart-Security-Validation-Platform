...
TOOL = "wafw00f"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": [], "positionals_first": false, "params": [{"key": "url", "label": "Target URL", "kind": "positional", "flag": "", "setting": "URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "find_all", "label": "Search all WAFs (-a)", "kind": "flag", "flag": "-a", "setting": "FIND_ALL", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "verbose", "label": "Verbose (-v)", "kind": "flag", "flag": "-v", "setting": "VERBOSE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "proxy", "label": "Proxy", "kind": "opt", "flag": "-p", "setting": "PROXY", "default": "", "required": false, "pattern": "url", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Timeout (s)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
