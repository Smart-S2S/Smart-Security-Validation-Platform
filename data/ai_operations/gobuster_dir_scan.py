...
"""Auto-generated SSVP wrapper for the "gobuster" tool (scan).
...
TOOL = "gobuster"
SPEC = json.loads(r'''{"mode": "argv", "fixed_pre": ["dir"], "positionals_first": false, "params": [{"key": "url", "label": "Hedef URL", "kind": "opt", "flag": "-u", "setting": "URL", "default": "", "required": true, "pattern": "url", "choices": [], "must_exist": false}, {"key": "wordlist", "label": "Sözlük dosyası", "kind": "opt", "flag": "-w", "setting": "WORDLIST", "default": "/usr/share/wordlists/dirb/common.txt", "required": true, "pattern": "path", "choices": [], "must_exist": true}, {"key": "threads", "label": "Thread sayısı", "kind": "opt", "flag": "-t", "setting": "THREADS", "default": "20", "required": false, "pattern": "int", "choices": [], "must_exist": false}, {"key": "extensions", "label": "Uzantılar", "kind": "opt", "flag": "-x", "setting": "EXTENSIONS", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "status_codes", "label": "Kabul edilen kodlar", "kind": "opt", "flag": "-s", "setting": "STATUS_CODES", "default": "", "required": false, "pattern": "ports", "choices": [], "must_exist": false}, {"key": "cookies", "label": "Cookie", "kind": "opt", "flag": "-c", "setting": "COOKIES", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "user_agent", "label": "User-Agent", "kind": "opt", "flag": "-a", "setting": "USER_AGENT", "default": "", "required": false, "pattern": "text", "choices": [], "must_exist": false}, {"key": "insecure", "label": "SSL doğrulamasını atla (-k)", "kind": "flag", "flag": "-k", "setting": "INSECURE", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "quiet", "label": "Sessiz (-q)", "kind": "flag", "flag": "-q", "setting": "QUIET", "default": "on", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "follow_redirect", "label": "Yönlendirmeyi izle (-r)", "kind": "flag", "flag": "-r", "setting": "FOLLOW_REDIRECT", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "add_slash", "label": "Sonuna / ekle (-f)", "kind": "flag", "flag": "-f", "setting": "ADD_SLASH", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "expanded", "label": "Tam URL (-e)", "kind": "flag", "flag": "-e", "setting": "EXPANDED", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_http", "label": "HTTP zaman aşımı", "kind": "opt", "flag": "--timeout", "setting": "TIMEOUT_HTTP", "default": "", "required": false, "pattern": "word", "choices": [], "must_exist": false}, {"key": "no_error", "label": "Hataları gizle (--no-error)", "kind": "flag", "flag": "--no-error", "setting": "NO_ERROR", "default": "", "required": false, "pattern": "safe", "choices": [], "must_exist": false}, {"key": "timeout_sec", "label": "Zaman aşımı (sn)", "kind": "none", "flag": "", "setting": "TIMEOUT_SEC", "default": "180", "required": false, "pattern": "int", "choices": [], "must_exist": false}]}''')
...
def _log(msg):
    print("[GOBUSTER] " + str(msg), flush=True)
